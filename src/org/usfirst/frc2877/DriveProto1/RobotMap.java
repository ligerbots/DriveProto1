...
public class RobotMap {
    ...
    public static void init() {
        ...
        /**
         * encoderTesterQuadratureEncoder1 = new Encoder(1, 1, 1, 2, false,
         * EncodingType.k4X); LiveWindow.addSensor("EncoderTester",
         * "QuadratureEncoder1", encoderTesterQuadratureEncoder1);
        ...
        //System.out.println("pneumaticPusherPushCompressor.start");
        //The first Digital Module is in cRIO slot 2, but it's referred to as slot 1 in the code
        servo1 = new Servo(1, 2);        
        spike1 = new Relay(1, 2);
        PIDOut = new DummyPIDOutput();
        
        pIDController1 = new PIDController(1, .3, .01, gyroSubsystemGyro1, PIDOut);
